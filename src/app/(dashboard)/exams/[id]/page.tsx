          ...
          <div className="fixed inset-0 z-50 bg-slate-900/80 overflow-y-auto no-print">
            <div className="min-h-screen py-8 px-4 flex justify-center">
              <div className="w-full max-w-[210mm] relative">
                ...
                {/* Answer Key Page */}
                {showAnswers && (
                  <div className="bg-white shadow-2xl rounded-lg mt-6 print-preview" style={{ padding: '20mm', minHeight: '200mm', fontFamily: 'Times New Roman, serif', fontSize: '14px', lineHeight: '1.8', color: '#000', pageBreakBefore: 'always' }}>
