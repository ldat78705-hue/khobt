...
export const CATEGORIES: Category[] = [
  ...
  { id: 'c5-5', name: 'CHỦ ĐỀ 5: HÌNH PHẲNG, CHU VI & DIỆN TÍCH', slug: 'chu-de-5-toan-5', description: 'Chủ đề 5', parent_id: null, grade: 5, icon: 'folder', color: '#22C55E', sort_order: 5, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c5-7', name: 'CHỦ ĐỀ 7: TỈ SỐ & BÀI TOÁN LIÊN QUAN', slug: 'chu-de-7-toan-5', description: 'Chủ đề 7', parent_id: null, grade: 5, icon: 'folder', color: '#06B6D4', sort_order: 7, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c5-8', name: 'CHỦ ĐỀ 8: THỂ TÍCH, ĐƠN VỊ ĐO THỂ TÍCH', slug: 'chu-de-8-toan-5', description: 'Chủ đề 8', parent_id: null, grade: 5, icon: 'folder', color: '#3B82F6', sort_order: 8, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c5-9', name: 'CHỦ ĐỀ 9: DT & THỂ TÍCH CỦA MỘT SỐ KHỐI', slug: 'chu-de-9-toan-5', description: 'Chủ đề 9', parent_id: null, grade: 5, icon: 'folder', color: '#6366F1', sort_order: 9, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c5-10', name: 'CHỦ ĐỀ 10: THỜI GIAN, TOÁN CHUYỂN ĐỘNG', slug: 'chu-de-10-toan-5', description: 'Chủ đề 10', parent_id: null, grade: 5, icon: 'folder', color: '#8B5CF6', sort_order: 10, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
