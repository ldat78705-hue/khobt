...
export const CATEGORIES: Category[] = [
  ...
  { id: 'cat-9-1', name: 'Căn bậc hai, Căn bậc ba', slug: 'can-thuc-9', description: 'Căn bậc hai, rút gọn biểu thức', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#8B5CF6', sort_order: 1, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-2', name: 'Phương trình & Hệ PT', slug: 'pt-he-pt-9', description: 'Phương trình và hệ hai phương trình bậc nhất hai ẩn', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#EC4899', sort_order: 2, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-3', name: 'Hệ thức lượng trong tam giác vuông', slug: 'luong-giac-9', description: 'Tỉ số lượng giác, hệ thức lượng', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#EF4444', sort_order: 3, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-4', name: 'Đường tròn & Đa giác đều', slug: 'duong-tron-9', description: 'Vị trí tương đối, góc nội tiếp, tứ giác nội tiếp', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#22C55E', sort_order: 4, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-5', name: 'Hàm số y = ax² & PT bậc hai', slug: 'ham-so-9', description: 'Hàm số y = ax², parabol, định lí Viète', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#F59E0B', sort_order: 5, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-6', name: 'Thống kê & Xác suất', slug: 'thong-ke-9', description: 'Tần số, biểu đồ, phép thử ngẫu nhiên', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#06B6D4', sort_order: 6, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-9-7', name: 'Một số hình khối trong thực tiễn', slug: 'hinh-khoi-9', description: 'Hình trụ, hình nón, hình cầu', parent_id: 'cat-9', grade: 9, icon: 'folder', color: '#14B8A6', sort_order: 7, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  ...
  { id: 'cat-8-1', name: 'Đa thức & Hằng đẳng thức', slug: 'da-thuc-8', description: 'Đa thức nhiều biến, Hằng đẳng thức đáng nhớ', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#14B8A6', sort_order: 1, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-2', name: 'Tứ giác', slug: 'tu-giac-8', description: 'Hình thang, hình bình hành, hình chữ nhật, thoi, vuông', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#F97316', sort_order: 2, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-3', name: 'Định lí Thalès & Tam giác đồng dạng', slug: 'tam-giac-8', description: 'Định lí Thalès, Định lí Pythagore, Tam giác đồng dạng', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#22C55E', sort_order: 3, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-4', name: 'Phân thức đại số', slug: 'phan-thuc-8', description: 'Tính chất, các phép toán phân thức', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#3B82F6', sort_order: 4, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-5', name: 'Phương trình & Hàm số bậc nhất', slug: 'pt-ham-so-8', description: 'PT bậc nhất, Hàm số bậc nhất', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#EC4899', sort_order: 5, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-6', name: 'Thống kê & Xác suất', slug: 'thong-ke-8', description: 'Thu thập dữ liệu, xác suất thực nghiệm', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#06B6D4', sort_order: 6, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-8-7', name: 'Hình khối thực tiễn', slug: 'hinh-chóp-8', description: 'Hình chóp tam giác đều, tứ giác đều', parent_id: 'cat-8', grade: 8, icon: 'folder', color: '#8B5CF6', sort_order: 7, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  ...
  { id: 'cat-7-1', name: 'Số hữu tỉ & Số thực', slug: 'so-huu-ti-thuc-7', description: 'Tập hợp số hữu tỉ, Số vô tỉ, Căn bậc hai', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#3B82F6', sort_order: 1, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-2', name: 'Góc và Đường thẳng song song', slug: 'goc-song-song-7', description: 'Tiên đề Euclid, Định lí', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#F97316', sort_order: 2, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-3', name: 'Tam giác bằng nhau & Quan hệ trong tam giác', slug: 'tam-giac-7', description: 'Các trường hợp bằng nhau, sự đồng quy', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#F59E0B', sort_order: 3, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-4', name: 'Tỉ lệ thức & Đại lượng tỉ lệ', slug: 'ti-le-thuc-7', description: 'Dãy tỉ số bằng nhau, Tỉ lệ thuận nghịch', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#14B8A6', sort_order: 4, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-5', name: 'Biểu thức & Đa thức một biến', slug: 'da-thuc-7', description: 'Phép tính đa thức một biến', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#8B5CF6', sort_order: 5, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-6', name: 'Thống kê & Xác suất', slug: 'thong-ke-7', description: 'Biểu đồ quạt, đoạn thẳng, biến cố', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#EC4899', sort_order: 6, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-7-7', name: 'Hình khối thực tiễn', slug: 'hinh-khoi-7', description: 'Hình hộp chữ nhật, lăng trụ đứng', parent_id: 'cat-7', grade: 7, icon: 'folder', color: '#06B6D4', sort_order: 7, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  ...
  { id: 'cat-5-1', name: 'Số thập phân & Phân số', slug: 'so-thap-phan-5', description: 'Phép tính phân số, số thập phân', parent_id: 'cat-5', grade: 5, icon: 'folder', color: '#F97316', sort_order: 1, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-5-2', name: 'Tỉ số phần trăm', slug: 'ti-so-phan-tram-5', description: 'Bài toán tỉ số phần trăm', parent_id: 'cat-5', grade: 5, icon: 'folder', color: '#3B82F6', sort_order: 2, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-5-3', name: 'Hình học phẳng', slug: 'hinh-hoc-phang-5', description: 'Chu vi, diện tích hình tam giác, hình thang, đường tròn', parent_id: 'cat-5', grade: 5, icon: 'folder', color: '#22C55E', sort_order: 3, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-5-4', name: 'Hình học không gian', slug: 'hinh-khong-gian-5', description: 'Thể tích hình lập phương, hộp chữ nhật', parent_id: 'cat-5', grade: 5, icon: 'folder', color: '#8B5CF6', sort_order: 4, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'cat-5-5', name: 'Toán chuyển động', slug: 'toan-chuyen-dong-5', description: 'Vận tốc, quãng đường, thời gian', parent_id: 'cat-5', grade: 5, icon: 'folder', color: '#EC4899', sort_order: 5, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
