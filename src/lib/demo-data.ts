...
export const CATEGORIES: Category[] = [
  ...
  { id: 'c7-7', name: 'CHƯƠNG VII. BIỂU THỨC ĐẠI SỐ, ĐA THỨC 1 BIẾN', slug: 'chuong-7-toan-7', description: 'Chương VII. Đa thức', parent_id: null, grade: 7, icon: 'folder', color: '#06B6D4', sort_order: 7, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c7-8', name: 'CHƯƠNG VIII. XÁC SUẤT CỦA BIẾN CỐ', slug: 'chuong-8-toan-7', description: 'Chương VIII. Xác suất', parent_id: null, grade: 7, icon: 'folder', color: '#3B82F6', sort_order: 8, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'c7-9', name: 'CHƯƠNG IX. QUAN HỆ CÁC YẾU TỐ TRONG TAM GIÁC', slug: 'chuong-9-toan-7', description: 'Chương IX. Quan hệ tam giác', parent_id: null, grade: 7, icon: 'folder', color: '#6366F1', sort_order: 9, is_active: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
