...
SELECT t.name, t.slug, 6, t.desc_, t.sort_order, '#EF4444', p.id FROM
(VALUES
...
-- Số nguyên
INSERT INTO public.categories (name, slug, grade, description, sort_order, color, parent_id)
SELECT t.name, t.slug, 6, t.desc_, t.sort_order, '#F97316', p.id FROM
(VALUES
...
-- Thống kê L6
INSERT INTO public.categories (name, slug, grade, description, sort_order, color, parent_id)
SELECT t.name, t.slug, 6, t.desc_, t.sort_order, '#10B981', p.id FROM
(VALUES
...
-- Số hữu tỉ
INSERT INTO public.categories (name, slug, grade, description, sort_order, color, parent_id)
SELECT t.name, t.slug, 7, t.desc_, t.sort_order, '#EF4444', p.id FROM
(VALUES
...
-- Tỉ lệ thức
INSERT INTO public.categories (name, slug, grade, description, sort_order, color, parent_id)
SELECT t.name, t.slug, 7, t.desc_, t.sort_order, '#F97316', p.id FROM
(VALUES
...
-- Thống kê L7
INSERT INTO public.categories (name, slug, grade, description, sort_order, color, parent_id)
SELECT t.name, t.slug, 7, t.desc_, t.sort_order, '#10B981', p.id FROM
(VALUES
